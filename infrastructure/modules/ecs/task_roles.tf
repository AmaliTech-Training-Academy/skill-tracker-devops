...
# DISABLED: ECS services need to be created first before autoscaling can be configured
# Uncomment after creating aws_ecs_service resources in services.tf
...
# DISABLED: Uncomment after ECS services are created
